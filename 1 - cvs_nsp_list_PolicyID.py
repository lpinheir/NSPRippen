...
filename = 'cvs_nsp_list_policyID' # Provide the filename
outpath = 'C:\\Users\\LPinheir\\OneDrive - McAfee\\4 - PROFESSIONAL SERVICES - ADVISORY\\McAfee\\Bradesco\\2020\\CVE API\OUTPUT\\' # Provide the Path for the OUTPUT FILE
